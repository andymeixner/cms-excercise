...
- A simple React app that displays the Wordpress posts via the Wordpress REST API. This app is located at root/frontend. The app can be launched using `npm start`. The app is set up to send GET requests to a Wordpress install at 'localhost:8888'
